...
Question: -
How does a dedicated Object Detection architecture (like YOLO) compared to a traditional CNN Classification model (ResNet-18) with Grad-CAM heatmaps in accurately localizing pulmonary opacities.
...
• Controls: The ResNet-18 classifier acts as the control. I will measure if the specialized detection loss in YOLOv8 yields significantly better localization than the classification-derived heatmaps.
• Metrics:
